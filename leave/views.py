...
def student_log(request):
    if request.method=="POST":
        ...
        if cr:
            ...
            return render(request,'student_log.html',{'wrong':"Wrong User name or password"})
    else:
        return render(request,'home.html')
...
def std_page(request):
    ...
    return render(request, 'std_welcome.html',{'username':username,'password':password})
...
def teacher_reg(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'teacher_reg.html', {'form': form, 'message': message})
    else:
        form = TeacherForm()
...
def teacher_page(request):
    username = request.session['username']
    password = request.session['password']
    return render(request, 'teacher_welcome.html',{'username':username,'password':password})
...
def view_std(request):
    ...
    if department:
        ...
        return render(request, 'view_student.html', {'students': queryset, 'department': department})
    else:
...
def approve_leave(request, username):
    ...
    if leave_request:
        ...
        return render(request, 'teacher_welcome.html')
